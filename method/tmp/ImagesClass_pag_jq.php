    ...
    public function showPagination($cu)
    {
        ...
        if ( $all > $this->default_on) {
            ...
            <script>
                $(function () {
                    //$( '.pagination_start' ).click(function() {
                        var totalphp = '<?php echo ceil($all/@$_COOKIE['limit']); ?>';
                        var obj = $('.pagination2').twbsPagination({
                            ...
                            onPageClick: function (event, page) {
                                ...
                                //var pagination = page;
                                //var start = (limit*pagination)-limit;
                                //$.cookie('start', pagination, { expires: 3600 });
                                //$.cookie('pagination', pagination, { expires: 3600 });//na potrzeby zaznaczania aktywnego
            ...
            <ul class="pagination2" id="pagination2">
				<li>
					<button class="form-control pagination_start">Prev</button>
				</li>
                <?php for($i = 1; $i <= ceil($all/@$_COOKIE['limit']); $i++) { ?>
                    <li>
                        <button class="form-control pagination_start <?php echo @$_COOKIE['pagination'] == $i ? 'p_active' : '' ; ?>" value="<?php echo $i; ?>">
                            <?php echo $i; ?>
                        </button>
                    </li>
                <?php } ?>
				<li>
					<button class="form-control pagination_start">Next</button>
				</li>
			</ul>
            <!-- paginacja -->
            <?php
